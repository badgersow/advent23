...
public class Twelfth2 {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while (in.hasNextLine()) {
            String partialRow = in.next();
            row = (partialRow + "?" + partialRow + "?" + partialRow + "?" + partialRow + "?" + partialRow).toCharArray();
            int[] partialGroups = Arrays.stream(in.next().split(",")).mapToInt(Integer::parseInt).toArray();
            groups = Stream.of(partialGroups, partialGroups, partialGroups, partialGroups, partialGroups)
