...
public class Eleventh2 {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        long coefficient = 1_000_000;
        long resultTwice = 0;
        for (var g1 : galaxies) {
            for (var g2 : galaxies) {
                // Vertical
                var i1 = g1[0] + noGalaxiesUpToI[g1[0]] * (coefficient - 1L);
                var i2 = g2[0] + noGalaxiesUpToI[g2[0]] * (coefficient - 1L);
                resultTwice += Math.abs(i1 - i2);

                // Horizontal
                var j1 = g1[1] + noGalaxiesUpToJ[g1[1]] * (coefficient - 1L);
                var j2 = g2[1] + noGalaxiesUpToJ[g2[1]] * (coefficient - 1L);
